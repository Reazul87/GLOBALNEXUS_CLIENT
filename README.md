...
- npm or yarn
- A running backend server (as indicated by `https://global-nexus-zeta.vercel.app` in the fetch requests).
...
3.  **Set up environment variables:**
    ...
    VITE_IMG_BB_KEY=YOUR IMG BB CONFIG

    # ... other firebase configs
    VITE_BACKEND_URL=https://global-nexus-zeta.vercel.app
    ```
...
2.  **Ensure the backend server is running:**
    This application communicates with a backend server, which is assumed to be running at `https://global-nexus-zeta.vercel.app`. Make sure your backend is properly set up and running for full functionality.
